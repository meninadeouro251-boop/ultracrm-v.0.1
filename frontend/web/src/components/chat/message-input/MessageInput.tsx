        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              onClick={onCancel}
              aria-label={t('messageInput.replyPreview.close')}
            >
              <X className="h-3 w-3" />
            </Button>
          </TooltipTrigger>
          <TooltipContent>{t('messageInput.replyPreview.close')}</TooltipContent>
        </Tooltip>
      </div>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  disabled={isSending}
                  aria-label={t('messageInput.cannedResponses.close')}
                >
                  <X className="h-3 w-3" />
                </Button>
              </TooltipTrigger>
              <TooltipContent>{t('messageInput.cannedResponses.close')}</TooltipContent>
            </Tooltip>
          </div>
        )}
            ...
            <div className="flex-shrink-0 flex items-center gap-1.5 pb-1">
              ...
              <div className="relative">
                <Tooltip>
                  ...
                  <TooltipContent>{t('messageInput.emojiPicker.tooltip')}</TooltipContent>
                </Tooltip>
                <EmojiPicker
              ...
              <Tooltip>
                ...
                <TooltipContent>{t('messageInput.cannedResponses.tooltip')}</TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                ...
                <TooltipContent>{t('messageTemplates.button.title')}</TooltipContent>
              </Tooltip>
            </div>
            ...
            <div className="flex-shrink-0 flex items-center gap-1.5 pb-1">
              {replyMode === ReplyMode.REPLY && !isPendingConversation && (
                <Tooltip>
                  ...
                  <TooltipContent>{t('messageInput.audio.tooltip')}</TooltipContent>
                </Tooltip>
              )}
